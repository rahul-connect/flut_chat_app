...
class ProfilePage extends StatelessWidget {
  ...
  Widget _profilePageUI(){
    ...
    ):Center(child: SpinKitWanderingCubes(color: Colors.blue,size: 50.0,),);
      });
    });
  }
  ...
  Widget _userNameWidget(String _userName){
    return Container(
      height: _height * 0.05,
      width: _width,
      child: Text(_userName,textAlign: TextAlign.center,style: TextStyle(
        color: Colors.white,
        fontSize: 30.0
      ),),
    );
  ...
  Widget _userEmailWidget(String _userEmail){
    return Container(
      height: _height * 0.03,
      width: _width,
      child: Text(_userEmail,textAlign: TextAlign.center,style: TextStyle(
